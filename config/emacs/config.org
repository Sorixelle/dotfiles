...
#+begin_src emacs-lisp :tangle no :noweb-ref DOOMLINE-CONFIG
...
#+begin_src emacs-lisp :tangle no :noweb-ref KIND-ICON-CONFIG
...
#+begin_src emacs-lisp :tangle no :noweb-ref ELIXIR-CONFIG
