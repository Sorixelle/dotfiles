...
** [[https://github.com/jming422/fira-code-mode][fira-code-mode]]
   Add pretty looking ligatures to my code, because they make me happy :)

   - Disable the following ligatures, because they either don't look very good,
     or they cause issues with other icons:
     - =[]=
     - =x=
     - =: =
     - =<~~=
