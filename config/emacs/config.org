...
Now, we can add another function to fixup this indentation behaviour for the modes we want it in. It'll fire that function we just called after hitting =RET=.

#+begin_src emacs-lisp :tangle yes
  (defun srxl/fix-brace-indentation (mode)
    "Adjust Smartparens brace insertion hook for MODE."
    (sp-local-pair mode "{" nil :post-handlers '((srxl/newline-indent "RET"))))
#+end_src
...
#+begin_src emacs-lisp :tangle yes
  (srxl/fix-brace-indentation 'js-mode)
#+end_src
...
And the brace indent fix.
#+begin_src emacs-lisp :noweb-ref TS-CONFIG
  (srxl/fix-brace-indentation 'typescript-mode)
#+end_src
...
And fix their curly braces.
#+begin_src emacs-lisp
  (srxl/fix-brace-indentation 'javascript-jsx-mode)
  (srxl/fix-brace-indentation 'typescript-tsx-mode)
#+end_src
...
#+begin_src emacs-lisp :tangle yes
  (use-package json-mode
    :mode "\\.json\\'"
    :config
    (srxl/fix-brace-indentation 'json-mode))
#+end_src
