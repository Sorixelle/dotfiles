...
** Window navigation
Navigating between windows is something I do in Emacs /constantly/. Keybindings to help me do that would be nice. Let's start off with a simple one - moving between windows. For that, we'll use the Vim arrows to move between windows.
...
NOTE: This snippet is being kept around since I have an open bug report for this in perspective-el, in case I need it to help troubleshoot there. I'm not really using EXWM anymore.
