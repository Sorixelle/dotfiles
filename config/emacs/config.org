...
***** Astro
Astro is pretty simple - [[https://github.com/Sorixelle/astro-mode][astro-mode]]. Fun fact - I wrote this package :3
#+begin_src emacs-lisp :tangle yes
  (use-package astro-mode
    :straight (astro-mode :host github :repo "Sorixelle/astro-mode")
    :mode "\\.astro\\'"
    :config
    <<ASTRO-CONFIG>>)
#+end_src
...
#+begin_src emacs-lisp :noweb-ref ASTRO-CONFIG
  ...
  (let ((opts (lambda (_) `(:typescript
    ...
    (add-to-list
     ...
     `(astro-mode . ("astro-ls" "--stdio" :initializationOptions ,opts))))
#+end_src
...
#+begin_src emacs-lisp :noweb-ref ASTRO-CONFIG
  (add-to-list
   ...
   '(prettier-astro npx "prettier" "--stdin-filepath" filepath "--parser=astro"
                    (apheleia-formatters-indent "--use-tabs" "--tab-width" 'astro-mode-indent-offset)))
...
#+begin_src emacs-lisp :noweb-ref ASTRO-CONFIG
  (srxl/fix-brace-indentation 'astro-mode "{" "(" "[")
#+end_src
*** BEAM (Erlang/Elixir)
