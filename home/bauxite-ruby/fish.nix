...

{
  programs.fish = {
    ...
    shellAbbrs = {
      ...
      # TODO: support --log-format in darwin-rebuild so nom can be used
      sys-rebuild = "darwin-rebuild -L --show-trace --flake ~/Nix switch";
      sys-test = "darwin-rebuild -L --show-trace --flake ~/Nix test";
      sys-upgrade = "nix flake update --flake ~/Nix && darwin-rebuild -L --show-trace --flake ~/Nix switch";
